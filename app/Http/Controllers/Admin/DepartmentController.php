...
class DepartmentController extends Controller
{
    ...
    public function store(Request $request)
    {
        $department = new Department([
            'department_name' => $request->post('txtDepartmentName'),
        ]);
        $department->save();    
    ...
    {
        $department = Department::find($request->post('hdnDepartmentId'));
                $department->department_name = $request->post('txtDepartmentName');
                $department->update();
        return Response::json($department);
    }
